...
class Start
{
    ...
    public function init()
    {
        ...
        Logs::initialize("", $_SERVER['REQUEST_METHOD']);
        if (!isset($_GET['param'])) {
        ...
        try {
            ...
            if ($seconds = Logs::accessIsInvalid($controller[1], $_SERVER['REQUEST_METHOD'])) {
                Response::sendResponse(406, ["msg" => "Too many invalid attempts, please try again within ".$seconds." seconds"]);
            }
            Logs::updateInfo(["resource" => $controller[1]]);
